  ...
  return (
    ...
    >
      <div className="grid gap-10 md:grid-cols-[1.55fr_1fr] md:gap-12 items-stretch">
        ...
        <div className="flex items-stretch justify-center order-2">
          <div className="relative w-full h-full min-h-[240px] md:min-h-[360px] overflow-hidden rounded-2xl border border-border bg-muted/30">
            <img
